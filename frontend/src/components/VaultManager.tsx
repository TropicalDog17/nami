        ...
        <div>
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    Click on any vault to view detailed information, P&L, and
                    transaction history.
                </p>
            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-gray-500">
                                        {formatNumber(vault.deposit_qty, 8)}{' '}
                                        {vault.asset}
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className="flex justify-between items-baseline">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <span
                                                className={`text-sm font-medium ml-2 ${isPositivePercent ? 'text-green-600' : 'text-red-600'}`}
                                            >
                                                ({isPositivePercent ? '+' : ''}
                                                {formatNumber(pnlPercent, 2)}%)
                                            </span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                    <li>
                        • Click on any vault card to view detailed P&L,
                        transaction history, and manage deposits/withdrawals
                    </li>
                    <li>• Active vaults allow deposits and withdrawals</li>
                    <li>
                        • End a vault when you&apos;re done to lock in final
                        returns
                    </li>
                    <li>
                        • All investment tracking is now vault-based for better
                        organization
                    </li>
                </ul>
            </div>
