...
const PnLDisplay: React.FC<PnLDisplayProps> = ({
    ...
    const unrealizedPnL = isUSD
        ? data.unrealized_pnl_usd
        : data.unrealized_pnl_vnd;
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p
                                    className={`text-2xl font-bold ${realizedPnLFormatted.colorClass} mt-2`}
                                >
                                    {realizedPnLFormatted.sign}
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p
                                    className={`text-2xl font-bold ${unrealizedPnLFormatted.colorClass} mt-2`}
                                >
                                    {unrealizedPnLFormatted.sign}
                                    {unrealizedPnLFormatted.value}
                                </p>
                            </div>
                    ...
                    <CardContent className="p-0">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p
                                    className={`text-2xl font-bold ${totalPnLFormatted.isPositive ? 'text-green-700' : totalPnLFormatted.isNegative ? 'text-red-700' : 'text-gray-700'} mt-2`}
                                >
                                    {totalPnLFormatted.sign}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex justify-between items-center py-4 border-b border-gray-200">
                            ...
                            <div className="text-right">
                                <p
                                    className={`text-lg font-bold ${roiPercentage >= 0 ? 'text-green-600' : 'text-red-600'}`}
                                >
                                    {roiPercentage >= 0 ? '+' : ''}
                                    {formatPercentage(roiPercentage, 2)}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center py-4 border-b border-gray-200">
                            ...
                            <div className="text-right">
                                <p
                                    className={`text-lg font-medium ${realizedPnLFormatted.colorClass}`}
                                >
                                    {realizedPnLFormatted.sign}
                                    {realizedPnLFormatted.value}
                                </p>
                        ...
                        <div className="flex justify-between items-center py-4">
                            ...
                            <div className="text-right">
                                <p
                                    className={`text-lg font-medium ${unrealizedPnLFormatted.colorClass}`}
                                >
                                    {unrealizedPnLFormatted.sign}
                                    {unrealizedPnLFormatted.value}
                                </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <Card className="text-center p-4 bg-gray-50 rounded-lg">
                    <CardContent className="p-0">
                        ...
                        <p
                            className={`text-xl font-bold ${totalPnL > 0 ? 'text-green-600' : totalPnL < 0 ? 'text-red-600' : 'text-gray-600'}`}
                        >
                ...
                <Card className="text-center p-4 bg-gray-50 rounded-lg">
                    <CardContent className="p-0">
                        ...
                        <p className="text-xl font-bold text-gray-900">
                            {totalCost > 0
                                ? formatPercentage(totalPnL / totalCost, 1)
                                : 'N/A'}
                        </p>
                    </CardContent>
                </Card>
                <Card className="text-center p-4 bg-gray-50 rounded-lg">
                    <CardContent className="p-0">
                        ...
                        <p
                            className={`text-xl font-bold ${totalPnLFormatted.colorClass}`}
                        >
                            {totalPnLFormatted.sign}
                            {formatPercentage(totalPnL / totalCost, 1)}
                        </p>
