...
const getActionSummary = (
    ...
    if (parsed && typeof parsed === 'object') {
        ...
        const pieces = [counterparty, amountLabel, date, tag].filter(Boolean);
...
export const AdminPendingActions = () => {
    ...
    const loadDetails = useCallback(
        async (id: string) => {
            ...
            try {
                const result =
                    await adminApi.getPendingAction<PendingAction>(id);
                if (result) {
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Review, accept, or reject actions generated from
                        Telegram inputs.
                    </p>
                </div>
                <div className="flex flex-wrap gap-3">
                    <label className="flex flex-col text-sm text-gray-600">
                        ...
                        <select
                            value={statusFilter}
                            onChange={(e) =>
                                setStatusFilter(e.target.value as PendingStatus)
                            }
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Select a pending action to inspect the raw data and
                ...
                {selected ? (
                    <div className="mt-4 space-y-4">
                        ...
                        {Array.isArray(selected.created_tx_ids) &&
                            selected.created_tx_ids.length > 0 && (
                                <div>
                                    <h4 className="text-sm font-semibold text-gray-700">
