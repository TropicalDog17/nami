...
const QuickIncomeModal = ({ isOpen, onClose, onSubmit }: Props) => {
    const { accounts, assets } = useApp() as {
        accounts: Array<{ is_active: boolean; name: string; type?: string }>;
        assets: Array<{ is_active: boolean; symbol: string; name?: string }>;
    };
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    handleInputChange('payer', e.target.value)
                                }
