...
const QuickVaultModal: React.FC<QuickVaultModalProps> = ({
    isOpen,
    onClose,
    onSubmit,
}) => {
    ...
    const validate = (): string | null => {
        ...
        if (!form.depositCost || Number(form.depositCost) <= 0)
            return 'Deposit cost must be > 0';
        if (!isUsdOnly && (!form.depositQty || Number(form.depositQty) <= 0))
            return 'Deposit quantity must be > 0';
            ...
            <DialogContent className="max-w-md">
                ...
                >
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="isUsdOnly" className="cursor-pointer">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {isUsdOnly ? (
                            <div className="px-3 py-2 border rounded-md bg-muted text-foreground flex items-center">
                                Quantity fixed to 1
                            </div>
                        ) : (
                            <div className="space-y-2">
                                <Label htmlFor="depositQty">
                                    Deposit Quantity
                                </Label>
                                <Input
                                    id="depositQty"
