...
import { getConnection, closeConnection, initializeDatabase } from '../database/connection';
  ...
  try {
    ...
    const store: StoreShape = {
      ...
      pendingActions: pendingActions.map((a: any) => ({
        ...
        created_tx_ids: a.created_tx_ids ? JSON.parse(a.created_tx_ids) : undefined
      })),
